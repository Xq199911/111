...
# Fixed by User (2025): Full Code - Added GenerationMode - H2O/Streaming Support - Fix Position IDs
    ...
    def prepare_inputs_for_generation_streaming(
        ...
        if not is_streaming:
            ...
            if ReadAction:
                ...
                # [CRITICAL FIX]: Use torch.arange for multi-token inputs (like Suffix)
