...
- Methods: Baseline (GPE), H2O, StreamingLLM, Head-Aware, Full
- Samples: 100 per method

### Phase 2: Budget Impact Analysis

- Budgets: 2048, 4096, 8192 tokens/layer
- Method: Full (Head-Aware + Group-Aware)

### Phase 3: Ablation Study

- Configurations: Baseline, Head-Aware only, Group-Aware only, Full
...
- **Ubuntu用户**: 查看 `scripts/ubuntu/README.md`
- **Windows用户**: 查看 `scripts/windows/README.md`
- **通用指南**: 查看 `EXPERIMENT_GUIDE.md`
