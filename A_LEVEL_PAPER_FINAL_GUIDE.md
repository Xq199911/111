...
4. Head-Aware - 仅使用Head-Aware
5. Full (Head-Aware + Group-Aware) - 完整方法

**每个方法运行**:
- 样本数: 100 samples
- 输出目录: `./output_logs/a_level_paper/long_seq_{长度}/{方法名}/`

**预期时间**: 每个序列长度 × 5种方法 × 100样本 ≈ 2-4小时

#### Phase 2: 预算影响分析

**测试预算**: 2048, 4096, 8192 tokens/layer

**运行方法**: Full (Head-Aware + Group-Aware)
...
2. Head-Aware only - 仅Head-Aware
3. Group-Aware only - 仅Group-Aware（如果支持）
4. Full (Head-Aware + Group-Aware) - 完整方法
